...
function setSuggestionsDisabled(disabled) {
  suggestionsList.classList.toggle("suggestions--disabled", disabled);
  suggestionsList.setAttribute("aria-disabled", disabled ? "true" : "false");
...
function setChatControlsBusy(isBusy) {
  chatForm.classList.toggle("chat-form--disabled", isBusy);
  chatForm.setAttribute("aria-busy", isBusy ? "true" : "false");
